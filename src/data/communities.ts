...
export const anchorCommunities: Community[] = [
  {
    ...
    domain: "culture",
    admins: [
      { name: "Anwar K.", role: "Founder" },
      { name: "Priya Menon", role: "Archive Lead" },
    ],
  ...
  },
  {
    ...
    domain: "tech",
    admins: [
      { name: "Rahul Krishna", role: "Community Lead" },
      { name: "Fathima S.", role: "Events Coordinator" },
    ],
    ...
    linkedPlatforms: [
      ...
      { platform: "instagram", url: "https://instagram.com/tinkerhubcalicut" },
  ...
  },
  {
    ...
    domain: "fitness",
    admins: [
      { name: "Ajith Kumar", role: "Captain" },
      { name: "Meera Das", role: "Route Planner" },
    ],
  ...
  },
  {
    ...
    entryLevel: "open",
    linkedPlatforms: [
      { platform: "instagram", url: "https://instagram.com/fofcalicut" },
